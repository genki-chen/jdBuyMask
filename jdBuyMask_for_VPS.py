...
global cookies_String, mail, sc_key, messageType, modelType, area, skuidsString, skuids, captchaUrl, eid, fp, payment_pwd, order_count
...
def add_item_to_cart(sku_id):
    ...
    if sku_id == '5008240' or sku_id == '1683285455' or sku_id == '44016967409' or sku_id == '65565257987':
        payload = {
            'pid': sku_id,
            'pcount': 5,
            'ptype': 1,
